...
function Footer() {
  return (
    <div style={{display : "flex", flexDirection: "column", height:'30vh'}}>
        <div style={{display: "flex", flexGrow: '1', background: "#D9D9D9", padding:'6px 0px'}}>

            <div style={{width: "33%", display: 'flex', flexDirection: "column", gap: "9px", padding: "10px 0px 10px 80px"}}>
                <div style={{width : "fit-content", height: "fit-content"}}>
                <img style={{height: "34px", objectFit : 'contain'}} src={OrderUk} alt="Company Image" />
                </div>
                <div style={{width : "fit-content", height: "fit-content"}}>
                <img style={{height: "26px", objectFit : 'contain'}} src={GooglePlay} alt="Google Play Image" />
                </div>
            ...
            <div style={{width: "33%", display: 'flex', flexDirection: "column", padding: "8px 0px 8px 0px"}}>
                ...
                <div style={{display: 'flex', gap:'12px', marginTop: "10px", paddingLeft: "24px"}}>
            ...
            <div style={{width: "33%", display: 'flex',  padding: "8px 24px 8px 28px"}}>
        ...
        <div style={{display: "flex", justifyContent: "space-between", justifyItems: "center",background: "#03081F", padding : "8px 80px", fontSize:"0.8rem"}}>
            <div style={{color: "#FFFFFF", fontFamily: "Poppins"}}>Order.uk Copyright 2024, All Rights Reserved.</div>
            <div style={{display: "flex", justifyContent: "space-around", justifyItems: "center", gap: "40px"}}>
